...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.table.header.Line 
...
an instance of plotly_study.graph_objs.table.header.Line"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.table.header import line as v_line
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.table.header.Font 
constructor must be a dict or 
an instance of plotly_study.graph_objs.table.header.Font"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.table.header import font as v_font
...
class Fill(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, colorsrc=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.table.header.Fill 
constructor must be a dict or 
an instance of plotly_study.graph_objs.table.header.Fill"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.table.header import fill as v_fill
