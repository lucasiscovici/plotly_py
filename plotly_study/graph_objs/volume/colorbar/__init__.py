...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.volume.colorbar.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.volume.colorbar.Title 
...
an instance of plotly_study.graph_objs.volume.colorbar.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.volume.colorbar import title as v_title
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.volume.colorbar.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.volume.colorbar.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.volume.colorbar import tickformatstop as v_tickformatstop
...
class Tickfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.volume.colorbar.Tickfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.volume.colorbar.Tickfont"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.volume.colorbar import tickfont as v_tickfont
...
from plotly_study.graph_objs.volume.colorbar import title
