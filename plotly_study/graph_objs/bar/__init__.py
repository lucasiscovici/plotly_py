...
class Unselected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of plotly_study.graph_objs.bar.unselected.Marker
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.unselected.Marker
        """
        return self["marker"]
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of plotly_study.graph_objs.bar.unselected.Textfont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.unselected.Textfont
        """
    ...
    def _prop_descriptions(self):
        return """\
        marker
            plotly_study.graph_objects.bar.unselected.Marker instance or
            dict with compatible properties
        textfont
            plotly_study.graph_objects.bar.unselected.Textfont instance
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        arg
            ...
            an instance of plotly_study.graph_objs.bar.Unselected
        marker
            plotly_study.graph_objects.bar.unselected.Marker instance or
            dict with compatible properties
        textfont
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Unselected 
...
an instance of plotly_study.graph_objs.bar.Unselected"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import unselected as v_unselected
...
class Textfont(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Textfont
        color
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Textfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Textfont"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import textfont as v_textfont
...
class Stream(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, maxpoints=None, token=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Stream
        maxpoints
            Sets the maximum number of points to keep on the plots
            from an incoming stream. If `maxpoints` is set to 50,
            only the newest 50 points will be displayed on the
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Stream 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Stream"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import stream as v_stream
...
class Selected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        The 'marker' property is an instance of Marker
        that may be specified as:
          - An instance of plotly_study.graph_objs.bar.selected.Marker
          - A dict of string/value properties that will be passed
            to the Marker constructor
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.selected.Marker
        """
        return self["marker"]
    ...
    def textfont(self):
        ...
        The 'textfont' property is an instance of Textfont
        that may be specified as:
          - An instance of plotly_study.graph_objs.bar.selected.Textfont
          - A dict of string/value properties that will be passed
            to the Textfont constructor
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.selected.Textfont
        """
        return self["textfont"]
    ...
    def _prop_descriptions(self):
        return """\
        marker
            plotly_study.graph_objects.bar.selected.Marker instance or
            dict with compatible properties
        textfont
            plotly_study.graph_objects.bar.selected.Textfont instance or
            dict with compatible properties
        """
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Selected
        marker
            plotly_study.graph_objects.bar.selected.Marker instance or
            dict with compatible properties
        textfont
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Selected 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Selected"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import selected as v_selected
...
class Outsidetextfont(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Outsidetextfont
        color
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Outsidetextfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Outsidetextfont"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import outsidetextfont as v_outsidetextfont
...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickformat
                    ...
                    "09~15~23.46"
                tickformatstops
                    A tuple of plotly_study.graph_objects.bar.marker.colo
                ...
                title
                    plotly_study.graph_objects.bar.marker.colorbar.Title
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.marker.ColorBar
        """
    ...
    def line(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            plotly_study.graph_objects.bar.marker.ColorBar instance or
            dict with compatible properties
        colorscale
            Sets the colorscale. Has an effect only if in
        ...
        colorsrc
            Sets the source reference on plot.ly for  color .
        line
            plotly_study.graph_objects.bar.marker.Line instance or dict
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Marker
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `marker.colorscale`. Has an effect only if in
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Marker 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Marker"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import marker as v_marker
...
class Insidetextfont(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Insidetextfont
        color
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Insidetextfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Insidetextfont"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import insidetextfont as v_insidetextfont
...
class Hoverlabel(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of plotly_study.graph_objs.bar.hoverlabel.Font
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly_study.graph_objs.bar.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.Hoverlabel
        align
            Sets the horizontal alignment of the text content
            within hover label box. Has an effect only if the hover
            label text spans more two or more lines
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.Hoverlabel 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.Hoverlabel"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import hoverlabel as v_hoverlabel
...
class ErrorY(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.ErrorY
        array
            Sets the data corresponding the length of each error
            bar. Values are plotted relative to the underlying
            data.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.ErrorY 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.ErrorY"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import error_y as v_error_y
...
class ErrorX(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.bar.ErrorX
        array
            Sets the data corresponding the length of each error
            bar. Values are plotted relative to the underlying
            data.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.bar.ErrorX 
constructor must be a dict or 
an instance of plotly_study.graph_objs.bar.ErrorX"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.bar import error_x as v_error_x
...
from plotly_study.graph_objs.bar import unselected
from plotly_study.graph_objs.bar import selected
from plotly_study.graph_objs.bar import marker
from plotly_study.graph_objs.bar import hoverlabel
