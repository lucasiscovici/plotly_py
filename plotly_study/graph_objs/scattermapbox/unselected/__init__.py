...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, opacity=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattermapbox.unselected.Marker 
...
an instance of plotly_study.graph_objs.scattermapbox.unselected.Marker"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scattermapbox.unselected import marker as v_marker
