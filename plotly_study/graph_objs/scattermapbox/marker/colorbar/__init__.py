...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.scattermapbox.marker.colorbar.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattermapbox.marker.colorbar.Title 
...
an instance of plotly_study.graph_objs.scattermapbox.marker.colorbar.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scattermapbox.marker.colorbar import title as v_title
...
class Tickformatstop(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.scattermapbox.marker.c
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattermapbox.marker.colorbar.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scattermapbox.marker.colorbar.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scattermapbox.marker.colorbar import (
...
class Tickfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattermapbox.marker.colorbar.Tickfont 
constructor must be a dict or 
...
from plotly_study.graph_objs.scattermapbox.marker.colorbar import title
