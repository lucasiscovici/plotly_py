...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.scattercarpet.marker.colorbar.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattercarpet.marker.colorbar.Title 
...
an instance of plotly_study.graph_objs.scattercarpet.marker.colorbar.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scattercarpet.marker.colorbar import title as v_title
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattercarpet.marker.colorbar.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scattercarpet.marker.colorbar.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scattercarpet.marker.colorbar import (
...
class Tickfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scattercarpet.marker.colorbar.Tickfont 
constructor must be a dict or 
...
from plotly_study.graph_objs.scattercarpet.marker.colorbar import title
