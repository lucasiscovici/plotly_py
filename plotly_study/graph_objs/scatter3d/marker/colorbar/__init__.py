...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.scatter3d.marker.colorbar.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.marker.colorbar.Title 
...
an instance of plotly_study.graph_objs.scatter3d.marker.colorbar.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.marker.colorbar import title as v_title
...
class Tickformatstop(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.scatter3d.marker.color
            bar.Tickformatstop
        dtickrange
            range [*min*, *max*], where "min", "max" - dtick values
            which describe some zoom level, it is possible to omit
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.marker.colorbar.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scatter3d.marker.colorbar.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.marker.colorbar import (
...
class Tickfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.marker.colorbar.Tickfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scatter3d.marker.colorbar.Tickfont"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.marker.colorbar import tickfont as v_tickfont
...
from plotly_study.graph_objs.scatter3d.marker.colorbar import title
