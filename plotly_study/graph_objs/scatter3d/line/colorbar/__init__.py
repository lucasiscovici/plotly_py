...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of plotly_study.graph_objs.scatter3d.line.colorbar.title.Font
        ...
        Returns
        -------
        plotly_study.graph_objs.scatter3d.line.colorbar.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        arg
            ...
            an instance of
            plotly_study.graph_objs.scatter3d.line.colorbar.Title
        font
            Sets this color bar's title font. Note that the title's
            font used to be set by the now deprecated `titlefont`
            attribute.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.line.colorbar.Title 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scatter3d.line.colorbar.Title"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.line.colorbar import title as v_title
...
class Tickformatstop(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.scatter3d.line.colorba
            r.Tickformatstop
        dtickrange
            range [*min*, *max*], where "min", "max" - dtick values
            which describe some zoom level, it is possible to omit
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.line.colorbar.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scatter3d.line.colorbar.Tickformatstop"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.line.colorbar import (
...
class Tickfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            plotly_study.graph_objs.scatter3d.line.colorbar.Tickfont
        color
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatter3d.line.colorbar.Tickfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.scatter3d.line.colorbar.Tickfont"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatter3d.line.colorbar import tickfont as v_tickfont
...
from plotly_study.graph_objs.scatter3d.line.colorbar import title
