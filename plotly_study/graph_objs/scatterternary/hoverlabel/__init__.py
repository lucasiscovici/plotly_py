    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.scatterternary.hoverlabel.Font 
...
an instance of plotly_study.graph_objs.scatterternary.hoverlabel.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.scatterternary.hoverlabel import font as v_font
