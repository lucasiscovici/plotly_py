    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.densitymapbox.hoverlabel.Font 
...
an instance of plotly_study.graph_objs.densitymapbox.hoverlabel.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.densitymapbox.hoverlabel import font as v_font
