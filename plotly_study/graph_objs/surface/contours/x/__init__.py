...
class Project(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.surface.contours.x.Project 
...
an instance of plotly_study.graph_objs.surface.contours.x.Project"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.surface.contours.x import project as v_project
