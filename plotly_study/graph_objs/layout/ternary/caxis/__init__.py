...
class Title(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.layout.ternary.caxis.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.ternary.caxis.Title 
...
an instance of plotly_study.graph_objs.layout.ternary.caxis.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.ternary.caxis import title as v_title
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.ternary.caxis.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.layout.ternary.caxis.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.ternary.caxis import (
...
class Tickfont(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.ternary.caxis.Tickfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.layout.ternary.caxis.Tickfont"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.ternary.caxis import tickfont as v_tickfont
...
from plotly_study.graph_objs.layout.ternary.caxis import title
