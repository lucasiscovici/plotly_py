...
class Font(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.annotation.hoverlabel.Font 
...
an instance of plotly_study.graph_objs.layout.annotation.hoverlabel.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.annotation.hoverlabel import font as v_font
