...
class Title(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.layout.scene.zaxis.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, text=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.scene.zaxis.Title 
...
an instance of plotly_study.graph_objs.layout.scene.zaxis.Title"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.scene.zaxis import title as v_title
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.scene.zaxis.Tickformatstop 
constructor must be a dict or 
an instance of plotly_study.graph_objs.layout.scene.zaxis.Tickformatstop"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.scene.zaxis import (
...
class Tickfont(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.scene.zaxis.Tickfont 
constructor must be a dict or 
an instance of plotly_study.graph_objs.layout.scene.zaxis.Tickfont"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.scene.zaxis import tickfont as v_tickfont
...
from plotly_study.graph_objs.layout.scene.zaxis import title
