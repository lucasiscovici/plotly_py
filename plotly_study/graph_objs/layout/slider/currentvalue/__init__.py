...
class Font(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.layout.slider.currentvalue.Font 
...
an instance of plotly_study.graph_objs.layout.slider.currentvalue.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.layout.slider.currentvalue import font as v_font
