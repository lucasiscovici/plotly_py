...
class Stream(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, maxpoints=None, token=None, **kwargs):
        ...
        arg
            ...
            an instance of plotly_study.graph_objs.heatmap.Stream
        maxpoints
            Sets the maximum number of points to keep on the plots
            from an incoming stream. If `maxpoints` is set to 50,
            only the newest 50 points will be displayed on the
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.heatmap.Stream 
...
an instance of plotly_study.graph_objs.heatmap.Stream"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.heatmap import stream as v_stream
...
class Hoverlabel(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of plotly_study.graph_objs.heatmap.hoverlabel.Font
        ...
        Returns
        -------
        plotly_study.graph_objs.heatmap.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of plotly_study.graph_objs.heatmap.Hoverlabel
        align
            Sets the horizontal alignment of the text content
            within hover label box. Has an effect only if the hover
            label text spans more two or more lines
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.heatmap.Hoverlabel 
constructor must be a dict or 
an instance of plotly_study.graph_objs.heatmap.Hoverlabel"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.heatmap import hoverlabel as v_hoverlabel
...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of plotly_study.graph_objs.heatmap.colorbar.Tickformatstop
        ...
        Returns
        -------
        tuple[plotly_study.graph_objs.heatmap.colorbar.Tickformatstop]
        """
    ...
    def title(self):
        ...
        Returns
        -------
        plotly_study.graph_objs.heatmap.colorbar.Title
        """
        return self["title"]
    ...
    def _prop_descriptions(self):
        ...
        tickformatstops
            A tuple of
            plotly_study.graph_objects.heatmap.colorbar.Tickformatstop
        ...
        tickwidth
            Sets the tick width (in px).
        title
            plotly_study.graph_objects.heatmap.colorbar.Title instance or
...
from plotly_study.graph_objs.heatmap import hoverlabel
from plotly_study.graph_objs.heatmap import colorbar
