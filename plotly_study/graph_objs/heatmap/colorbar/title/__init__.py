...
class Font(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.heatmap.colorbar.title.Font 
...
an instance of plotly_study.graph_objs.heatmap.colorbar.title.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.heatmap.colorbar.title import font as v_font
