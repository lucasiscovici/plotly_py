    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.slices.Z 
...
an instance of plotly_study.graph_objs.isosurface.slices.Z"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.slices import z as v_z
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.slices.Y 
constructor must be a dict or 
an instance of plotly_study.graph_objs.isosurface.slices.Y"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.slices import y as v_y
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.slices.X 
constructor must be a dict or 
an instance of plotly_study.graph_objs.isosurface.slices.X"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.slices import x as v_x
