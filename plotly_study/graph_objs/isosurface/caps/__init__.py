...
class Z(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, fill=None, show=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.caps.Z 
...
an instance of plotly_study.graph_objs.isosurface.caps.Z"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.caps import z as v_z
...
class Y(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, fill=None, show=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.caps.Y 
constructor must be a dict or 
an instance of plotly_study.graph_objs.isosurface.caps.Y"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.caps import y as v_y
...
class X(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, fill=None, show=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.isosurface.caps.X 
constructor must be a dict or 
an instance of plotly_study.graph_objs.isosurface.caps.X"""
            )
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.isosurface.caps import x as v_x
