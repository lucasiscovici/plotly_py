    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.sankey.node.hoverlabel.Font 
...
an instance of plotly_study.graph_objs.sankey.node.hoverlabel.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.sankey.node.hoverlabel import font as v_font
