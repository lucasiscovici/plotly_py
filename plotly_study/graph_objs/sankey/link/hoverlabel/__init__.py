    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.sankey.link.hoverlabel.Font 
...
an instance of plotly_study.graph_objs.sankey.link.hoverlabel.Font"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.sankey.link.hoverlabel import font as v_font
