...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.choroplethmapbox.marker.Line 
...
an instance of plotly_study.graph_objs.choroplethmapbox.marker.Line"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.choroplethmapbox.marker import line as v_line
