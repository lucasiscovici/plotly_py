...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, opacity=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly_study.graph_objs.choroplethmapbox.unselected.Marker 
...
an instance of plotly_study.graph_objs.choroplethmapbox.unselected.Marker"""
        ...
        # Import validators
        # -----------------
        from plotly_study.validators.choroplethmapbox.unselected import marker as v_marker
